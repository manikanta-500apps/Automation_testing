...
#         And  I add "user01@yopmail.com" into the inputfield with "email" and id "form_input_email" with in "5" seconds
#         And  I add "dj3fke6eq4gte30bju6m1vtskg" into the inputfield with "API key" and id "form_input_api_key" with in "5" seconds
#         And  I add "durgaprasad" into the inputfield with "domain" and id "form_input_domain" with in "5" seconds
#         And  I wait for the element "//button[normalize-space()='Save']" with in "10" seconds
#         And  I click on the button using text "Save"
...
#         When I click on the linktext "Domain Search"
#         And  I wait for the element "//small[normalize-space()='Bulk Domain Search']" with in "30" seconds
#         And  I click on the element contains text "Bulk Domain Search"
#         And  I upload a file "BulkDS50.csv" in "finder" app using class "file-input"
