...
#         When I wait for the element "//audio[@controls='controls']" with in "4" seconds
#         And  I click on "Delete" icon in a row
#         When I click on the button using text "Delete"
...
#         And  I click on "Delete" icon in a row
#         And  I click on the button using "Confirm"
#         Then I expect that element text "Testing@Dailer" does not exist "yes"
